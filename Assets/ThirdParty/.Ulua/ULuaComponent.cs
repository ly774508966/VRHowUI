...
/// </summary>
[AddComponentMenu("Lua/ULuaComponent")]
public class ULuaComponent : MonoBehaviour
{
    ...
    /// </summary>
    public static LuaTable GetULuaComponent(GameObject go)
    {
        ULuaComponent luaComp = go.GetComponent<ULuaComponent>();
        if (luaComp == null)
            return null;
    ...
    /// </summary>
    public static LuaTable AddULuaComponent(GameObject go, TextAsset luaFile)
    {
        ULuaComponent luaComp = go.AddComponent<ULuaComponent>();
    ...
    void RunLuaFile(TextAsset luaFile)
    {
        ...
        object[] luaRet = s_luaState.DoString(luaFile.text, luaFile.name);
        ...
        {
            Debug.LogError("not return lua table object " + luaFile.name);
        }
    }
